...
export const automationServerCapabilities: CapabilityManifest[] = [
  ...
  // =====================================
  {
    ...
    kind: "tool",
    version: "0.1.0",
    description: "Classifies the intent of a customer support ticket based on text.",
    riskLevel: "low",
    sideEffectLevel: "local-read",
    requiredApproval: false,
  },
  {
    ...
    kind: "tool",
    version: "0.1.0",
    description: "Retrieves context (policies, macros, past tickets) relevant to a support ticket.",
    riskLevel: "low",
    sideEffectLevel: "local-read",
    requiredApproval: false,
  },
  {
    ...
    kind: "tool",
    version: "0.1.0",
    description: "Drafts a reply to a support ticket using context.",
    riskLevel: "low",
    sideEffectLevel: "local-read",
    requiredApproval: false,
  },
  {
    ...
    kind: "tool",
    version: "0.1.0",
    description: "Validates a drafted support reply against compliance and policy rules.",
    riskLevel: "low",
    sideEffectLevel: "local-read",
    requiredApproval: false,
  },
  {
    ...
    kind: "tool",
    version: "0.1.0",
    description: "Redacts or tokenizes PII from a support payload.",
    riskLevel: "low",
    sideEffectLevel: "local-read",
    requiredApproval: false,
  },
  {
    ...
    kind: "tool",
    version: "0.1.0",
    description: "Dry-runs a support action (e.g. refund, escalate) to preview its impact.",
    riskLevel: "low",
    sideEffectLevel: "external-read",
    requiredApproval: false,
  },
  {
    ...
    kind: "tool",
    version: "0.1.0",
    description: "Stages a support action for human review and returns an approval token.",
    riskLevel: "medium",
    sideEffectLevel: "external-read",
    requiredApproval: false,
  },
  {
    ...
    kind: "tool",
    version: "0.1.0",
    description: "Consumes an approval token to autonomously execute a support action (e.g. issue refund, close ticket).",
    riskLevel: "critical",
    sideEffectLevel: "external-submit",
    requiredApproval: true,
  },
  {
    ...
    kind: "tool",
    version: "0.1.0",
    description: "Detects gaps in current support documentation based on unresolved tickets.",
    riskLevel: "low",
    sideEffectLevel: "local-read",
    requiredApproval: false,
  },
