...
1. **Create the OKF Profile**: Fork `docs/reference/ocf-profile.md` into `it-ops-profile.md`. Define new schemas (e.g., `Server`, `Incident`, `Runbook`).
2. **Update `@ocf/core`**: Add Zod validation schemas for the new types.
